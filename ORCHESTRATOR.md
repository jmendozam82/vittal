...
| @IngenieroDatos | Migración SQL | `/skills/skill-supabase.md` |
| @IngenieroDatos | Repository DAL | `/skills/skill-dal.md` |
| @EspecialistaUI | BLL Service | `/skills/skill-bll.md` |
| @EspecialistaUI | API Controller | `/skills/skill-controller.md` |
| @EspecialistaUI | Vistas Razor | `/skills/skill-view.md` |
