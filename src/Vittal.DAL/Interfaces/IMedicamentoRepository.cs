...
public interface IMedicamentoRepository
{
    ...
    /// <summary>Busca medicamentos por término (nombre, descripción). SQL ILIKE.</summary>
    Task<IEnumerable<Medicamento>> SearchAsync(Guid clinicaId, string term, int limit = 20);
}
