...
/// La password se env�a a Supabase Auth � NO se persiste en la tabla usuarios.
/// </summary>
public class UsuarioRequestDto
{
    ...
    /// <summary>
    /// Requerida solo en Create. Opcional en Update (si se env�a, se actualiza en Supabase Auth).
    /// M�nimo 6 caracteres.
    /// </summary>
    [StringLength(255, MinimumLength = 6, ErrorMessage = "La contrase�a debe tener al menos 6 caracteres.")]
    ...
    [StringLength(30, MinimumLength = 5, ErrorMessage = "El n�mero de documento debe tener entre 5 y 30 caracteres")]
    public string NumeroDocumentoIdentificacion { get; set; } = string.Empty;


    [StringLength(20, ErrorMessage = "El n�mero de celular no puede exceder 20 caracteres.")]
