...
/// Implementa IAsyncAuthorizationFilter para evitar async-over-sync antipattern.
/// </summary>
...
public class RequirePermissionAttribute : Attribute, IAsyncAuthorizationFilter
{
    ...
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        // Verificar permiso de forma asíncrona
        var result = await permisoService.HasPermissionAsync(clinicaId, perfilId, _module, _permissionType);
