...
/// <summary>
/// API REST para gestión de Exámenes en Hojas de Cita.
/// Historia de Usuario: HU20 — Expedientes
/// </summary>
[ApiController]
[Route("api/hojas-examen")]
[Authorize]
...
public class HojasExamenController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] HojaExamenRequestDto dto)
    {
        var clinicaId = User.GetClinicaId();
        ...
        {
            var response = new ApiResponse<HojaExamenResponseDto>
            {
                Success = true,
    ...
    [ProducesResponseType(typeof(ApiResponse<HojaExamenResponseDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] HojaExamenRequestDto dto)
    {
        var clinicaId = User.GetClinicaId();
